...
<tr>
    <td><a href="https://github.com/KsyLight/cv-analyzer-gazprom-neft">Streamlit-приложение по анализу резюме и по матрицу Альянса ИИ</td>
    <td>
       <ul>
        <li>Обработано более 700 резюме, с разметкой и их чтением, а также созданием словарей меток;</li>
        <li>Дообучена модель RoBeRtA от Facebook на вывод вектора компетенций;</li>
        <li>Создано Streamlit-приложение по анализу компетенций по матрице Альянса ИИ;</li>
        <li>Веб-приложение поставлено на арендованный сервер.</li>
      </ul>
    </td>
    <td>Можно посмотреть непосредственно в репозитории проекта</td>
  </tr>
  <tr>
